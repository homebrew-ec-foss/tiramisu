...
title: home
layout: page
scripts: ["featured_post.js", "live.js", "redirect.js"]
---
...
<div style="display: flex; flex-direction: column; gap: 0.8rem;">
  ...
  <a href="/announcements/fosstalks-2/" style="text-decoration: none; color: inherit; display: flex; flex-direction: column; padding: 0.6rem; border-radius: 8px; background-color: rgba(0,0,0,0.02); transition: background-color 0.15s ease; flex: 1;">
    <div style="width: 100%; height: 120px; background-image: url('https://i.imgur.com/7I8zaCy.png'); background-size: cover; background-position: center; border-radius: 6px; margin-bottom: 0.4rem;"></div>
    <h4 style="font-size: 0.9rem; margin: 0 0 0.2rem 0; color: var(--color-primary);">FOSS Talks 2.0</h4>
    <p style="font-size: 0.7rem; margin: 0; color: var(--color-text-dim);">February 2025</p>
  </a>
  
  <a href="/announcements/tilde-4.0/" style="text-decoration: none; color: inherit; display: flex; flex-direction: column; padding: 0.6rem; border-radius: 8px; background-color: rgba(0,0,0,0.02); transition: background-color 0.15s ease; flex: 1;">
    <div style="width: 100%; height: 120px; background-image: url('https://i.imgur.com/51JRzZL.png'); background-size: cover; background-position: center; border-radius: 6px; margin-bottom: 0.4rem;"></div>
    <h4 style="font-size: 0.9rem; margin: 0 0 0.2rem 0; color: var(--color-primary);">Buzzing with eBPF</h4>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/raQrUlURXEc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
</div>
...
<div class="video-card">
<div class="video-container">
<iframe width="560" height="315" src="https://www.youtube.com/embed/as27j9Tt_FE" title="Tilde 4.0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
</div>
